 ...
 *
 */
public class PowerOffServerCommand implements Command {
	...
	public PowerOffServerCommand(Client client, String serverId) {
		this.client = client;
	 ...
	 * @param serverId
	 * @return {String} Resource url			Example:/servers/{serverId}/actions/power-off
	 */
	private String getResourceUrl(String serverId) {
		StringBuilder sb = new StringBuilder();
		sb.append(SERVERS_RESOURCE).append("/").append(serverId).append(ACTIONS).append(POWER_OFF);
		return sb.toString();
	}
